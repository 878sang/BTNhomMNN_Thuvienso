...
<div class="mb-4">
    ...
    <h2 class="fw-bold">Chỉnh sửa tác giả</h2>
</div>
        ...
        <div class="card border-0 shadow-sm p-4">
            <form action="{{ route('admin.authors.update', $author) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $author->name) }}" placeholder="VD: Ngô Tất Tố, Nam Cao" required>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    @if($author->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $author->image) }}" class="rounded-circle shadow-sm" width="100" height="100" style="object-fit: cover;">
                        </div>
                    @endif
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="bio" name="bio" rows="6" placeholder="Mô tả ngắn gọn về tiểu sử tác giả...">{{ old('bio', $author->bio) }}</textarea>
                    @error('bio')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
